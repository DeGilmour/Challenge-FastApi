...
def add_sprinkler(db: Session, sprinkler: models_schema.Sprinkler):
...
def get_all_sprinklers(db: Session):
...
def set_water_flow(db: Session, sprinkler_id: int, water_flow: int) -> models_table.Sprinkler:
...
def add_plant_in_sprinkler_area(db: Session, plant_id: int, sprinkler_id: int):
...
def get_all_plants_in_sprinkler_area(db: Session, sprinkler_id: int):
